...
"//edgeFade=1-pow(sin(edgeFade*3),2);\n"
"\n"
"    float3 pp =p;\n"
"    //p*=noise3(p*4);    \n"
"    p+=rot3(pp,noise3(p*26.41))*.0812;\n"
"    //p/=1+edgeFade;\n"
"\n"
"      //  p+=rot3(p,noise3(p*20.41))*.0812;\n"
"    \n"
"\n"
"    float c=.1/cells3D(p);\n"
"    float cc=.1/saturate(c)+edgeFade;\n"
"    \n"
"    c+=edgeFade;\n"
"    \n"
"    c*=1+.1/cells3D((p*2));\n"
"    //c/=1.5;\n"
"    \n"
"    //c=c/3+.1/c*saturate(1-edgeFade*3);\n"
"    //c*=1+cells3D(p*2.3)/2*edgeFade;\n"
"   // c*=1+cells3D(p*4.3)/4*(1-edgeFade);\n"
"    //c/=51;\n"
"\n"
"    \n"
"\n"
...
"    \n"
"    //c=noise3(p/c);\n"
"    //p/=1+6.61*rot3(p*2,noise3(p*2)+time.x/452);\n"
"//    float3 c = (noise3(.001/p*.3)+.70);\n"
"c=ACESFilm(max(c,0)*.13);\n"
"    //c*=float3(9,1,.25)*length(p);\n"
"    \n"
"    //c*=pow(edgeFade,1)*25;\n"
"\n"
"    //c+=.1+sin(.002/c/edgeFade+3.2);\n"
"    //c=pow(c,2);\n"
"//    c*=pow(edgeFade,4)*12*float3(3,1,0.2);\n"
"//c*=pow(edgeFade,2)+.05;\n"
"//c=lerp(c,pow(noise3(input.wpos)/2+.5,12)*62,edgeFade);\n"
"//=pow(edgeFade,2.4)*35;\n"
" \n"
"//c=1/c;\n"
"//c*=saturate(pow(edgeFade,5)*125)*3.25; \n"
"float3 c2=c*float3(15,1,.3)*5;\n"
"    //c2.r-=noise(p*2)*edgeFade*2;\n"
"//edgeFade=1;\n"
"    //if (c.r*edgeFade*12<.03+hash(p*12).r*.01) discard;\n"
"    //if (dot(c,1)<edgeFade*no42).x) discard;\n"
"    //if (cc*edgeFade<.006) discard;\n"
"    return float4(c2,saturate(edgeFade*8) ); \n"
"\n"
"}\n"
;
