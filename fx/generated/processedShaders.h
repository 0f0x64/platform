...
"}\n"
"\n"
"float3 floor_space(uint qid,float3 pos,float4 grid)\n"
"{\n"
"    uint cn=7;\n"
"    float a= (qid%cn);\n"
"    a=a*PI/180.;\n"
...
"        p.rgba = float4(noise3_u(a*float3(13,15,12)*221+77),1)/14.+.0015;\n"
"     \n"
"         p.sz=172;\n"
"    }\n"
"    else\n"
...
"        p.rgba = float4(noise3_u(a*float3(13,15,12)*221+77+sin(pos2*1.4)),1)/90.+.0015;;\n"
"\n"
