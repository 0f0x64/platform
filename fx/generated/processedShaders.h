...
"{\n"
"    // 1. ¬˚˜ËÒÎˇÂÏ ÍÓÒËÌÛÒ Û„Î‡ (0 Ì‡ Í‡ˇı, 1 ‚ ˆÂÌÚÂ)\n"
"    float dotProduct = dot(normal, viewDir);\n"
"    \n"
"    // 2. »Ì‚ÂÚËÛÂÏ Ë Ó„‡ÌË˜Ë‚‡ÂÏ (1 Ì‡ Í‡ˇı, 0 ‚ ˆÂÌÚÂ)\n"
"    float fresnel =  saturate(dotProduct);\n"
"    \n"
"    // 3. ¬ÓÁ‚Ó‰ËÏ ‚ ÒÚÂÔÂÌ¸ ‰Îˇ Ì‡ÒÚÓÈÍË ÂÁÍÓÒÚË ÔÂÂıÓ‰‡\n"
...
"    float3 g_1=mesh[(iid+hash(iid)*161)%3990]/4.8;\n"
"    float3 g_2=mesh[(iid+hash(iid)*2311)%3990]/4.8;\n"
"    float3 g_1_2=g_1;\n"
"    float3 g_2_2=g_2;\n"
...
"    g_2=lerp(g_2,g,saturate(distance(g,g_2)*sd/2.2));\n"
"\n"
...
"    float3 f1=mesh[(iid+212)%3990]/4.8;\n"
"    \n"
"    //g=lerp(f0,f1,hash(iid/22.)*saturate(6.8/distance(f0,f1)));\n"
"    g=getRandomPointInTriangle(g,g_1,g_2,iid/134.);\n"
"\n"
...
"    float phi=p.z;\n"
"    float3 cartesian;\n"
"    // –í HLSL –æ–±—ã—á–Ω–æ Y ‚Äî —ç—Ç–æ –≤–µ—Ä—Ö (Up), –ø–æ—ç—Ç–æ–º—É:\n"
...
"    \n"
"    // –ï—Å–ª–∏ —Ç–æ—á–∫–∞ –≤ —Ü–µ–Ω—Ç—Ä–µ –∫–æ–æ—Ä–¥–∏–Ω–∞—Ç, —É–≥–ª—ã –Ω–µ –æ–ø—Ä–µ–¥–µ–ª–µ–Ω—ã\n"
"    if (radius <= 0.0) return float3(0, 0, 0);\n"
"\n"
"    // theta = —É–≥–æ–ª –≤ –ø–ª–æ—Å–∫–æ—Å—Ç–∏ XZ (–∞–∑–∏–º—É—Ç)\n"
"    // –ò—Å–ø–æ–ª—å–∑—É–µ–º atan2(z, x) –¥–ª—è –ø–æ–ª–Ω–æ–≥–æ –¥–∏–∞–ø–∞–∑–æ–Ω–∞ [-PI, PI]\n"
"    float theta = atan2(p.z, p.x);\n"
"    \n"
"    // phi = —É–≥–æ–ª –æ—Ç –æ—Å–∏ Y (–∑–µ–Ω–∏—Ç) [0, PI]\n"
"    // acos –≤–æ–∑–≤—Ä–∞—â–∞–µ—Ç –∑–Ω–∞—á–µ–Ω–∏—è –æ—Ç 0 –¥–æ PI\n"
