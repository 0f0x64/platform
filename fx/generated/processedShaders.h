...
"}\n"
"\n"
"float calcRA(float2 uv, float2 sz,float a, float r)\n"
"{\n"
"\n"
"    float2 s = normalize(sz) / float2(1, a);\n"
"    float r1 = min(s.x, s.y) * (0.001 + r * 2.);\n"
"    float r2 = roundedBoxSDF(uv ,  s/2, r1) * 2.4 / r1;\n"
"    return 1 - sign(r2);\n"
"    return r2;\n"
"}\n"
"\n"
...
"    float2 uv = input.uv;\n"
"    float2 sz = input.sz;\n"
"    float2 uvs = (input.uv - .5) / (sz.x / sz.y);\n"
"    float d = calcRA(uvs, sz, iAspect, .25);\n"
"    float c = .5 + (-uvs.x - uvs.y);\n"
"    c = 1;//\n"
"    \n"
"    //d = sdRoundBox(uvs, sz, .25);\n"
"    \n"
"    //c = 1-d;\n"
"    //d = 1 - sign(d);\n"
"    //d = 1 - d;\n"
