...
"    float3 F0 = .04;\n"
"    \n"
"    float3 nrml = normals.SampleLevel(sam1, input.uv,2).xyz;\n"
...
"   \n"
"    select(pos,float3(0,0,2.3),.7,4);\n"
"    pos = rotX(pos,lcoef*.3);\n"
"    pos = move(pos,float3(0,0,-lcoef*.1));\n"
"\n"
...
"    pos.xz*=.7;\n"
"  /* \n"
"    select(pos,float3(0,.1,2.3),1,4,float3(0,0,0));\n"
"    \n"
"    pos=rotX(pos,.5*lcoef);\n"
"    pos = move(pos,float3(0,.5,0));*/\n"
"\n"
"    //select(pos,float3(.0,.9,0),1.3,5.9,float3(0,0,0));\n"
"    //pos = move(pos,float3(0,-.7,0));\n"
"    \n"
"    //pos*=sin(pos.y*3)*.1+1;\n"
"    //pos.z *= 1-cos(a.y*3)*.5;\n"
"    //pos.y *= cos(pos.x*3)*.07+1;\n"
"    //pos.x*=.2;\n"
"    //pos=rotZ(pos,pos.x/2);\n"
"    //pos.y-=saturate(-pos.y)*sin(abs(a.y*2))*sin(abs(a.x*3));\n"
"    //pos.x-=pow(cos(pos.y*3),4)*.3;\n"
"    \n"
"    \n"
"    \n"
"    \n"
...
"    float3 posX = sphere(uv+float2(.01,0))*2;\n"
"    float3 posY = sphere(uv+float2(0,0.01))*2;\n"
"    float3 t = normalize(posX-pos);\n"
"    float3 b = normalize(posY-pos);\n"
"    float3 n= -cross(t,b);\n"
"\n"
"    float a1= sin(a.x*PI*4096/2)+sin(a.y*PI*4096/2);\n"
"    float3 ofs= n*a1;\n"
"    ofs+= (-b)*a1;\n"
"    \n"
"    pos+=ofs*.7;\n"
"    \n"
"    pos+=a1*float3(sin(uv.x*1214),sin(uv.y*212),sin(uv.y*122))*.05;\n"
