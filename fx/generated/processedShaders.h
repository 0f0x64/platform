...
"        pos=pos2*2;\n"
"        pos*=float3(3,.025,3);\n"
"        pos.y-=6+noise(pos+time.x*.00125);\n"
"        pos=rotY(pos,length(pos)/2-time.x*.0135);\n"
"         // pos=rotZ(pos,pow(length(pos2),9)*.00001);\n"
"        pos+=noise3(pos);\n"
"        pos*=.35;\n"
"    }\n"
"\n"
"    //if (qid%5==0) pos=lerp(pos2*5,normalize(pos2)*17,1);\n"
"    if (qid%star_==0) pos=star(pos2*.7);\n"
"\n"
"    if (qid%outer==0) \n"
"    {\n"
"        pos2=rot3(pos,pos/12-4);\n"
"        pos=normalize(pos2)*12+pos2*1;\n"
"        \n"
"    }\n"
"    //pos=star(pos2*.7);\n"
"\n"
...
"    gzw*=1+br2*92/scale;\n"
"\n"
"    if (qid%outer==0) gzw*=(qid%150)==0 ? 23:1;\n"
"    \n"
...
"    \n"
"    //color\n"
"    outp.rgba=float4(noise3(pos*.31+2+a*4)+.1,1)/7+.04;\n"
"    if (qid%2!=0) outp.rgba.rgb+=float3(.4,.1,0);\n"
"    outp.rgba/=.24*posT.z;\n"
"    int q2 = qid%1716;\n"
"    if (q2==0&&!br2) outp.rgba=.5;\n"
"    outp.rgba/=length(scale*scale*scale)+1;\n"
"    \n"
"    //outp.rgba=lerp(float4(1,2,3,1)*.005,outp.rgba,1-saturate(length(pos)/22));\n"
"   // outp.rgba*=smoothstep(35,0,length(pos));\n"
"   // outp.rgba=1;if (br2) outp.rgba*=0;\n"
"    \n"
"     if (qid%2==0) outp.rgba*=float4(1,2,3,1);\n"
"     if (qid%outer==0) outp.rgba*=6;\n"
