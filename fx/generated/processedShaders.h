...
"\n"
"    pos.xyz = noise3(qid*float3(.00015,.00022,.00033)*2);\n"
"    pos.xyz /= 1+noise3(pos.xyz*8+time.x*.01);\n"
"\n"
"    pos.xyz += noise3(pos.xyz*3+time.x*.01);\n"
"\n"
"    pos.xyz*=1+pow(qid,.98)*.00004;\n"
"    \n"
"\n"
"\n"
"    pos.xyz=normalize(pos.xyz)*18;\n"
"    pos = mul(pos, model);\n"
"\n"
"\n"
"\n"
...
"    output.pos.xy+=(grid.zw-.5)*.03;\n"
"    float br = (qid%100000) ==  0  ? 1 : 0;\n"
"    output.pos.xy+=(grid.zw-.5)*br*32.5;\n"
"    \n"
