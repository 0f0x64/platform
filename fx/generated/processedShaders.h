...
"    a*=360./cn;\n"
"    float t=time.x*.1;\n"
"    float3 pos = pillar(grid.xy,0,t*.01,.5)/5;\n"
"    pos+=noise3(qid*float3(1,2,3)*.001)*.1;\n"
"   // pos*=4;\n"
"    //pos=frac(pos*12)*4;\n"
"    float3 pos2=pos;\n"
"  //      pos/=float3(1,3,3);\n"
"     //   pos+=noise(pos*3+time.x*.005)*.5;\n"
"       // pos=rot3(pos,float3(0,1.65,1.33));\n"
"        //pos=rotY(pos,length(pos)*.36-(time.x*.00135)+a);\n"
"        //pos.y*=sin(length(pos)*4)/2;\n"
"        //pos.y-=1.5;\n"
"        //pos.y-=length(pos)/8;\n"
"        //pos*=2.36;\n"
...
"        pos.xz*=12;\n"
"        \n"
"        pos=rotY(pos,length(pos)*.3+a);\n"
"        pos.y+=length(pos)/7;\n"
"//        pos.y*=.04*pow(length(pos),.5);\n"
"        pos.y-=4.5;\n"
"        \n"
"       //pos.xz*=2;\n"
"\n"
...
"     //p.rgba.rgb+=noise(rotY(pos,length(pos)))*.1;\n"
"\n"
"        if (qid%1000==0)\n"
"        {\n"
"            p.rgba=40;\n"
