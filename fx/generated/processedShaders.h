...
"    float3 p = normalize(input.wpos.xyz);\n"
"\n"
"    float3 wp = input.wpos.xyz+PosRad.xyz;\n"
"    float3 cameraPos   = GetWorldSpaceCameraPos(view[0]);\n"
"    float3 worldViewDir = GetWorldViewDir(wp, cameraPos);\n"
"    \n"
"    // Мягкий базовый Френель\n"
"    float edgeFade = CalculateFresnelFade(wp, worldViewDir, 3.);\n"
"    float t = time.x * 0.01;\n"
"\n"
"    // Стабильный базис для радиальных лучей (без багов при смещении)\n"
"    float3 dirToPixel = normalize(p); \n"
"\n"
