...
//====================
		NewLine();
		AddPointToLine({ -740000, 30065, 800000 });
		AddPointToLine({ -728788, -3527, 780944 });
		AddPointToLine({ -717580, -36863, 761884 });
		AddPointToLine({ -706368, -70195, 742824 });
		AddPointToLine({ -695156, -103527, 723768 });
		AddPointToLine({ -683948, -136863, 704712 });
		AddPointToLine({ -672736, -170195, 685652 });
		...
		NewLine();
		AddPointToLine({ -672736, -170195, 685652 });
		AddPointToLine({ -695310, -133528, 660385 });
		AddPointToLine({ -717884, -96861, 635118 });
		AddPointToLine({ -740458, -60195, 609851 });
		AddPointToLine({ -763032, -23528, 584584 });
		AddPointToLine({ -785606, 13139, 559316 });
		AddPointToLine({ -809180, 49805, 534048 });
		...
		NewLine();
		AddPointToLine({ -672736, -170195, 685652 });
		AddPointToLine({ -627672, -123527, 572996 });
		AddPointToLine({ -582612, -76863, 460340 });
		AddPointToLine({ -537548, -30195, 347680 });
		AddPointToLine({ -492484, 16473, 235024 });
		AddPointToLine({ -447424, 63137, 122368 });
		AddPointToLine({ -402360, 109805, 9712 });
		...
		NewLine();
		AddPointToLine({ -402360, 109805, 9712 });
		AddPointToLine({ -402360, 43137, -90064 });
		AddPointToLine({ -402360, -23527, -189844 });
		AddPointToLine({ -402360, -90195, -289624 });
		AddPointToLine({ -402360, -156863, -389400 });
		AddPointToLine({ -402360, -223527, -489176 });
		AddPointToLine({ -402360, -290195, -588956 });
		...
		NewLine();
		AddPointToLine({ -402360, -290195, -588956 });
		AddPointToLine({ -288784, -223527, -679816 });
		AddPointToLine({ -175204, -156863, -770680 });
		AddPointToLine({ -61628, -90195, -861540 });
		AddPointToLine({ 51948, -23527, -952400 });
		AddPointToLine({ 165528, 43137, -1043264 });
		AddPointToLine({ 279104, 109805, -1134124 });
		...
		NewLine();
		AddPointToLine({ -402360, 109805, 9712 });
		AddPointToLine({ -350112, 56473, -19024 });
		AddPointToLine({ -297864, 3137, -47760 });
		AddPointToLine({ -245616, -50195, -76496 });
		AddPointToLine({ -193372, -103527, -105236 });
		AddPointToLine({ -141124, -156863, -133972 });
		AddPointToLine({ -88876, -210195, -162708 });
		...
		NewLine();
		AddPointToLine({ -88876, -210195, -162708 });
		AddPointToLine({ 10528, -156863, -227320 });
		AddPointToLine({ 109928, -103527, -291932 });
		AddPointToLine({ 209332, -50195, -356544 });
		AddPointToLine({ 308736, 3137, -421152 });
		AddPointToLine({ 408136, 56473, -485764 });
		AddPointToLine({ 507540, 109805, -550376 });
		...
		NewLine();
		AddPointToLine({ -672736, -170195, 685652 });
		AddPointToLine({ -652960, -136863, 695540 });
		AddPointToLine({ -633184, -103527, 705428 });
		AddPointToLine({ -613408, -70195, 715316 });
		AddPointToLine({ -593628, -36863, 725204 });
		AddPointToLine({ -573852, -3527, 735092 });
		AddPointToLine({ -554076, 29805, 744980 });
		...
		NewLine();
		AddPointToLine({ -554076, 29805, 744980 });
		AddPointToLine({ -506400, -43527, 766172 });
		AddPointToLine({ -458720, -116863, 787360 });
		AddPointToLine({ -411040, -190195, 808552 });
		AddPointToLine({ -363364, -263527, 829744 });
		AddPointToLine({ -315688, -336863, 850932 });
		AddPointToLine({ -268008, -410195, 872124 });
		...
		//====================
		NewLine();
		AddPointToLine({ -560000, 109805, 1060000 });
		AddPointToLine({ -511336, 23137, 1036020 });
		AddPointToLine({ -462672, -63527, 1012040 });
		AddPointToLine({ -414004, -150195, 988064 });
		AddPointToLine({ -365340, -236863, 964084 });
		AddPointToLine({ -316676, -323527, 940104 });
		AddPointToLine({ -268008, -410195, 872124 });
		...
		NewLine();
		AddPointToLine({ -268008, -410195, 872124 });
		AddPointToLine({ -182596, -316863, 902016 });
		AddPointToLine({ -97184, -223527, 931912 });
		AddPointToLine({ -11772, -130195, 961808 });
		AddPointToLine({ 73640, -36863, 991700 });
		AddPointToLine({ 159052, 56473, 1021592 });
		AddPointToLine({ 244464, 149805, 1051488 });
		...
		NewLine();
		AddPointToLine({ -268008, -410195, 872124 });
		AddPointToLine({ -210008, -290195, 786572 });
		AddPointToLine({ -152004, -170195, 701024 });
		AddPointToLine({ -94004, -50195, 615472 });
		AddPointToLine({ -36004, 69805, 530320 });
		AddPointToLine({ 22000, 189805, 444372 });
		AddPointToLine({ 80000, 309805, 360000 });
		...
		NewLine();
		AddPointToLine({ 80000, 309805, 360000 });
		AddPointToLine({ 205328, 189805, 206668 });
		AddPointToLine({ 330652, 69805, 53332 });
		AddPointToLine({ 455980, -50195, -100000 });
		AddPointToLine({ 581308, -170195, -253332 });
		AddPointToLine({ 706632, -290195, -406668 });
		AddPointToLine({ 831960, -410195, -560000 });
		...
		NewLine();
		AddPointToLine({ 80000, 309805, 360000 });
		AddPointToLine({ 165668, 233137, 340000 });
		AddPointToLine({ 251332, 156473, 310000 });
		AddPointToLine({ 337000, 79805, 270000 });
		AddPointToLine({ 422668, 3137, 220000 });
		AddPointToLine({ 528332, -73527, 140000 });
		AddPointToLine({ 620000, -150195, 50000 });
		...
		NewLine();
		AddPointToLine({ 620000, -150195, 50000 });
		AddPointToLine({ 626668, -130195, 70000 });
		AddPointToLine({ 633332, -110195, 100000 });
		AddPointToLine({ 640000, -90195, 120000 });
		AddPointToLine({ 646668, -70195, 140000 });
		AddPointToLine({ 653332, -50195, 150000 });
		AddPointToLine({ 660000, -30195, 160000 });
		...
		NewLine();
		AddPointToLine({ 660000, -30195, 160000 });
		AddPointToLine({ 726668, -60195, 180000 });
		AddPointToLine({ 793332, -90195, 200000 });
		AddPointToLine({ 860000, -120195, 220000 });
		AddPointToLine({ 926668, -150195, 240000 });
		AddPointToLine({ 993332, -180195, 255000 });
		AddPointToLine({ 920000, -210195, 260000 });
