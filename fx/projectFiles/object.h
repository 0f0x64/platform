...
// 1 -> 14 = 60000 единиц
//
// При скорости 500 ед/сек:
// 60000 / 500 = 120 сек = 2 минуты
//============================================================
...
// Y = глубина
//
// Расстояния примерно в 2 раза больше исходных
// за счёт разнесения по Y.
//============================================================
...
//====================
		NewLine();
		AddPointToLine({ 10000,52000,50000 });
		AddPointToLine({ 28941,95730,43363 });
		AddPointToLine({ 47900,139459,37654 });
		AddPointToLine({ 66921,183189,31026 });
		...
		NewLine();
		AddPointToLine({ 66921,183189,31026 });
		AddPointToLine({ 59336,147666,16800 });
		AddPointToLine({ 51750,112143,-6458 });
		AddPointToLine({ 43204,76520,-11664 });
		...
		NewLine();
		AddPointToLine({ 66921,183189,31026 });
		AddPointToLine({ 81152,150174,34830 });
		AddPointToLine({ 95367,113159,38621 });
		AddPointToLine({ 109612,76144,42411 });
		...
		NewLine();
		AddPointToLine({ 66921,183189,31026 });
		AddPointToLine({ 76311,100039,2502 });
		AddPointToLine({ 85846,16890,-29900 });
		AddPointToLine({ 95381,-66259,-54355 });
		...
		NewLine();
		AddPointToLine({ 95381,-66259,-54355 });
		AddPointToLine({ 95381,24514,-85720 });
		AddPointToLine({ 95381,105287,-117084 });
		AddPointToLine({ 95381,186060,-149223 });
		...
		NewLine();
		AddPointToLine({ 95381,186060,-149223 });
		AddPointToLine({ 123835,93528,-171050 });
		AddPointToLine({ 152299,989,-192878 });
		AddPointToLine({ 180763,-91550,-215631 });
		...
		NewLine();
		AddPointToLine({ 95381,-66259,-54355 });
		AddPointToLine({ 120998,24515,-73340 });
		AddPointToLine({ 146567,105288,-92331 });
		AddPointToLine({ 171276,186061,-111276 });
		...
		NewLine();
		AddPointToLine({ 171276,186061,-111276 });
		AddPointToLine({ 199737,91000,-136900 });
		AddPointToLine({ 228198,-4059,-160000 });
		AddPointToLine({ 256658,-75118,-187171 });
		...
		//====================
		NewLine();
		AddPointToLine({ 47976,-26689,116408 });
		AddPointToLine({ 98298,54800,105024 });
		AddPointToLine({ 149450,139800,93630 });
		AddPointToLine({ 199737,274060,83204 });
		...
		NewLine();
		AddPointToLine({ 109612,76144,42411 });
		AddPointToLine({ 140000,142116,55700 });
		AddPointToLine({ 170000,208088,69200 });
		AddPointToLine({ 199737,274060,83204 });
		...
		NewLine();
		AddPointToLine({ 199737,274060,83204 });
		AddPointToLine({ 228198,204240,104280 });
		AddPointToLine({ 256658,134420,125230 });
		AddPointToLine({ 285118,64600,144868 });
		...
		NewLine();
		AddPointToLine({ 199737,274060,83204 });
		AddPointToLine({ 215874,218862,59400 });
		AddPointToLine({ 231080,163664,35800 });
		AddPointToLine({ 247171,108466,12053 });
		...
		NewLine();
		AddPointToLine({ 247171,108466,12053 });
		AddPointToLine({ 266142,205600,-28700 });
		AddPointToLine({ 285118,302734,-69600 });
		AddPointToLine({ 304092,399868,-111276 });
		...
		NewLine();
		AddPointToLine({ 247171,108466,12053 });
		AddPointToLine({ 275631,27300,-4990 });
		AddPointToLine({ 304092,-53900,-22600 });
		AddPointToLine({ 332552,-135100,-40125 });
		...
		NewLine();
		AddPointToLine({ 332552,-135100,-40125 });
		AddPointToLine({ 344930,-104565,-40125 });
		AddPointToLine({ 357000,-74030,-40125 });
		AddPointToLine({ 370500,-43500,-40125 });
		...
		NewLine();
		AddPointToLine({ 370500,-43500,-40125 });
		AddPointToLine({ 386637,-78000,-32500 });
		AddPointToLine({ 402000,-112500,-24900 });
		AddPointToLine({ 417934,-147000,-16408 });
