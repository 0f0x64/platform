...
//====================
		...
		AddPointToLine({ 12803,  21667, 45236 });
		AddPointToLine({ 15605,  13333, 40471 });
		AddPointToLine({ 18408,   5000, 35706 });
		AddPointToLine({ 21211,  -3333, 30942 });
		AddPointToLine({ 24013, -11667, 26178 });
		AddPointToLine({ 26816, -20000, 21413 });
		...
		NewLine();
		AddPointToLine({ 26816, -20000, 21413 });
		AddPointToLine({ 20131,  -9167,  15096 });
		AddPointToLine({ 13446,   1667,   8779 });
		AddPointToLine({ 6760,  12500,   2462 });
		AddPointToLine({ 75,  23333,  -3854 });
		AddPointToLine({ -3610,  29167, -10171 });
		AddPointToLine({ -7295,  35000, -16488 });
		...
		NewLine();
		AddPointToLine({ 26816, -20000,   21413 });
		AddPointToLine({ 38082,  -8333,  -6751 });
		AddPointToLine({ 49347,   3333, -34915 });
		AddPointToLine({ 60613,  15000, -63080 });
		AddPointToLine({ 71879,  26667, -91244 });
		AddPointToLine({ 83144,  38333,-119408 });
		AddPointToLine({ 94410,  50000,-147572 });
		...
		NewLine();
		AddPointToLine({ 94410,  50000,-147572 });
		AddPointToLine({ 94410,  33333,-172516 });
		AddPointToLine({ 94410,  16667,-197461 });
		AddPointToLine({ 94410,      0,-222406 });
		AddPointToLine({ 94410, -16667,-247350 });
		AddPointToLine({ 94410, -33333,-272294 });
		AddPointToLine({ 94410, -50000,-297239 });
		...
		NewLine();
		AddPointToLine({ 94410, -50000,-297239 });
		AddPointToLine({ 122804, -33333,-319954 });
		AddPointToLine({ 151199, -16667,-342670 });
		AddPointToLine({ 179593,      0,-365385 });
		AddPointToLine({ 207987,  16667,-388100 });
		AddPointToLine({ 236382,  33333,-410816 });
		AddPointToLine({ 264776,  50000,-433531 });
		...
		NewLine();
		AddPointToLine({ 94410,  50000,-147572 });
		AddPointToLine({ 107472,  36667,-154756 });
		AddPointToLine({ 120534,  23333,-161940 });
		AddPointToLine({ 133596,  10000,-169124 });
		AddPointToLine({ 146657,  -3333,-176309 });
		AddPointToLine({ 159719, -16667,-183493 });
		AddPointToLine({ 172781, -30000,-190677 });
		...
		NewLine();
		AddPointToLine({ 172781, -30000,-190677 });
		AddPointToLine({ 197632, -16667,-206830 });
		AddPointToLine({ 222482,  -3333,-222983 });
		AddPointToLine({ 247333,  10000,-239136 });
		AddPointToLine({ 272184,  23333,-255288 });
		AddPointToLine({ 297034,  36667,-271441 });
		AddPointToLine({ 321885,  50000,-287594 });
		...
		NewLine();
		AddPointToLine({ 26816, -20000, 21413 });
		AddPointToLine({ 31760, -11667, 23885 });
		AddPointToLine({ 36704,  -3333, 26357 });
		AddPointToLine({ 41648,   5000, 28829 });
		AddPointToLine({ 46593,  13333, 31301 });
		AddPointToLine({ 51537,  21667, 33773 });
		AddPointToLine({ 56481,  30000, 36245 });
		...
		NewLine();
		AddPointToLine({ 56481,  30000, 36245 });
		AddPointToLine({ 68400,  11667, 41543 });
		AddPointToLine({ 80320,  -6667, 46840 });
		AddPointToLine({ 92240, -25000, 52138 });
		AddPointToLine({ 104159, -43333, 57436 });
		AddPointToLine({ 116078, -61667, 62733 });
		AddPointToLine({ 127998, -80000, 68031 });
		...
		//====================
		NewLine();
		AddPointToLine({ 55000,  50000,115000 });
		AddPointToLine({ 67166,  28333,109005 });
		AddPointToLine({ 79332,   6667,103010 });
		AddPointToLine({ 91499, -15000, 97016 });
		AddPointToLine({ 103665, -36667, 91021 });
		AddPointToLine({ 115831, -58333, 85026 });
		AddPointToLine({ 127998, -80000, 68031 });
		...
		NewLine();
		AddPointToLine({ 127998, -80000,  68031 });
		AddPointToLine({ 149351, -56667,  75504 });
		AddPointToLine({ 170704, -33333,  82978 });
		AddPointToLine({ 192057, -10000,  90452 });
		AddPointToLine({ 213410,  13333,  97925 });
		AddPointToLine({ 234763,  36667, 105398 });
		AddPointToLine({ 256116,  60000, 112872 });
		...
		NewLine();
		AddPointToLine({ 127998, -80000,  68031 });
		AddPointToLine({ 142498, -50000,  46643 });
		AddPointToLine({ 156999, -20000,  25256 });
		AddPointToLine({ 171499,  10000,   3868 });
		AddPointToLine({ 185999,  40000, -17420 });
		AddPointToLine({ 200500,  70000, -38907 });
		AddPointToLine({ 215000, 100000, -60000 });
...
//====================
		NewLine();
		AddPointToLine({ 215000, 100000, -60000 });
		AddPointToLine({ 246332,  70000,-98333 });
		AddPointToLine({ 277663,  40000,-136667 });
		AddPointToLine({ 308995,  10000,-175000 });
		AddPointToLine({ 340327, -20000,-213333 });
		AddPointToLine({ 371658, -50000,-251667 });
		AddPointToLine({ 402990, -80000,-290000 });
		...
		NewLine();
		AddPointToLine({ 215000, 100000, -60000 });
		AddPointToLine({ 229167,  80833, -64167 });
		AddPointToLine({ 243333,  61667, -68333 });
		AddPointToLine({ 257500,  42500, -72500 });
		AddPointToLine({ 271667,  23333, -76667 });
		AddPointToLine({ 285833,   4167, -80833 });
		AddPointToLine({ 300000, -15000, -85000 });
		...
		NewLine();
		AddPointToLine({ 300000, -15000, -85000 });
		AddPointToLine({ 310000, -10000, -85000 });
		AddPointToLine({ 320000,  -5000, -85000 });
		AddPointToLine({ 330000,      0, -85000 });
		AddPointToLine({ 340000,   5000, -85000 });
		AddPointToLine({ 350000,  10000, -85000 });
		AddPointToLine({ 360000,  15000, -85000 });
		...
		NewLine();
		AddPointToLine({ 360000,  15000, -85000 });
		AddPointToLine({ 370833,   7500, -85000 });
		AddPointToLine({ 381667,      0, -85000 });
		AddPointToLine({ 392500,  -7500, -85000 });
		AddPointToLine({ 403333, -15000, -85000 });
		AddPointToLine({ 414167, -22500, -85000 });
		AddPointToLine({ 425000, -30000, -85000 });
