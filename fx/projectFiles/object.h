...
//====================
		...
		NewLine();
		AddPointToLine({ 77264, -170195, -64348 });
		AddPointToLine({ 50524, -126863, -89616 });
		AddPointToLine({ 23784, -83527, -114884 });
		AddPointToLine({ -2960, -40195, -140152 });
		AddPointToLine({ -29700, 3137, -165416 });
		AddPointToLine({ -44440, 26473, -190684 });
		...
		NewLine();
		AddPointToLine({ 830000, 309805, -390000 });
		AddPointToLine({ 886668, 233137, -406668 });
		AddPointToLine({ 943332, 156473, -423332 });
		AddPointToLine({ 1000000, 79805, -440000 });
		AddPointToLine({ 1056668, 3137, -456668 });
		AddPointToLine({ 1113332, -73527, -473332 });
		AddPointToLine({ 1170000, -150195, -490000 });
		...
		NewLine();
		AddPointToLine({ 1170000, -150195, -490000 });
		AddPointToLine({ 1210000, -130195, -490000 });
		AddPointToLine({ 1250000, -110195, -490000 });
		AddPointToLine({ 1290000, -90195, -490000 });
		AddPointToLine({ 1330000, -70195, -490000 });
		AddPointToLine({ 1370000, -50195, -490000 });
		AddPointToLine({ 1410000, -30195, -490000 });
		...
		NewLine();
		AddPointToLine({ 1410000, -30195, -490000 });
		AddPointToLine({ 1453332, -60195, -490000 });
		AddPointToLine({ 1496668, -90195, -490000 });
		AddPointToLine({ 1540000, -120195, -490000 });
		AddPointToLine({ 1583332, -150195, -490000 });
		AddPointToLine({ 1626668, -180195, -490000 });
