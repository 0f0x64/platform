...
// Конец:  X = 110000
//
// Основное направление — X.
// Скручивание — примерно 90°.
// ============================================================
		...
		AddPointToLine({ 14000, 50000, 50000 });
		AddPointToLine({ 18000, 50000, 50000 });
		AddPointToLine({ 22000, 50000, 50000 });
		AddPointToLine({ 26000, 50000, 50000 });
		...
		AddPointToLine({ 30000, 49700, 50300 });
		AddPointToLine({ 34000, 49000, 51000 });
		AddPointToLine({ 38000, 48000, 52000 });
		AddPointToLine({ 42000, 46800, 53500 });
		AddPointToLine({ 46000, 45800, 55200 });
		AddPointToLine({ 50000, 45200, 57000 });
		...
		AddPointToLine({ 54000, 45500, 59000 });
		AddPointToLine({ 58000, 46500, 60800 });
		AddPointToLine({ 62000, 48000, 62000 });
		AddPointToLine({ 66000, 50000, 62500 });
		...
		AddPointToLine({ 70000, 52000, 62000 });
		AddPointToLine({ 74000, 53700, 61000 });
		AddPointToLine({ 78000, 54800, 59500 });
		AddPointToLine({ 82000, 55300, 57500 });
		...
		AddPointToLine({ 86000, 55500, 55500 });
		AddPointToLine({ 90000, 55500, 54500 });
		AddPointToLine({ 94000, 55500, 53500 });
		AddPointToLine({ 98000, 55500, 52500 });
		AddPointToLine({ 102000, 55500, 51500 });
		AddPointToLine({ 106000, 55500, 50500 });
		AddPointToLine({ 110000, 55500, 50000 });
