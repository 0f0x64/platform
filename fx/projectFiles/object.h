...
// Z = 50000
//
// Одна нить приходит снаружи.
// Остальные нити закручиваются вокруг звезды.
// ============================================================


// ============================================================
// ВНЕШНЯЯ НИТЬ
// Длинная нить снаружи подходит к клубку
// ============================================================

		NewLine();
		AddPointToLine({ 25000, 43000, 70000 });
		AddPointToLine({ 34000, 45500, 65000 });
		AddPointToLine({ 43000, 50000, 61000 });
		AddPointToLine({ 52000, 57000, 59000 });
		AddPointToLine({ 62000, 65000, 61000 });
		AddPointToLine({ 71000, 70000, 65000 });
		AddPointToLine({ 80000, 72000, 62000 });
		AddPointToLine({ 87500, 69000, 57000 });
		AddPointToLine({ 93000, 63000, 52500 });
		AddPointToLine({ 97000, 57000, 48000 });


		// ============================================================
		// ВНЕШНЕЕ ОБВИТИЕ — СЛЕВА
		// ============================================================

		NewLine();
		AddPointToLine({ 87500, 45000, 65000 });
		AddPointToLine({ 93000, 39000, 70000 });
		AddPointToLine({ 100000, 35000, 72000 });
		AddPointToLine({ 112000, 33000, 70500 });
		AddPointToLine({ 124000, 35000, 67000 });
		AddPointToLine({ 133000, 40000, 61000 });
		AddPointToLine({ 138000, 47000, 54000 });
		AddPointToLine({ 136000, 55000, 46500 });
		AddPointToLine({ 128000, 62000, 41000 });
		AddPointToLine({ 117000, 67000, 39500 });
		...
		NewLine();
		AddPointToLine({ 93000, 40000, 54000 });
		AddPointToLine({ 96500, 35000, 61000 });
		AddPointToLine({ 103000, 32500, 66000 });
		AddPointToLine({ 112000, 33000, 68500 });
		AddPointToLine({ 121000, 35500, 66000 });
		AddPointToLine({ 128000, 41000, 60000 });
		AddPointToLine({ 130000, 48000, 52000 });
		AddPointToLine({ 126000, 55000, 45000 });
		AddPointToLine({ 118000, 59500, 41500 });
		AddPointToLine({ 108000, 61000, 43000 });
		...
		NewLine();
		AddPointToLine({ 96500, 38000, 47000 });
		AddPointToLine({ 101000, 34000, 52000 });
		AddPointToLine({ 108000, 31500, 58500 });
		AddPointToLine({ 117000, 32500, 62500 });
		AddPointToLine({ 125000, 37000, 61500 });
		AddPointToLine({ 130000, 43000, 55500 });
		AddPointToLine({ 129000, 50000, 48500 });
		AddPointToLine({ 123000, 55500, 44000 });
		AddPointToLine({ 115000, 58000, 42000 });
		AddPointToLine({ 106000, 56500, 44500 });
		...
		NewLine();
		AddPointToLine({ 99000, 42000, 42000 });
		AddPointToLine({ 104000, 37000, 47000 });
		AddPointToLine({ 111000, 34500, 53500 });
		AddPointToLine({ 119000, 36000, 58000 });
		AddPointToLine({ 125000, 40500, 57000 });
		AddPointToLine({ 128000, 46000, 51500 });
		AddPointToLine({ 125000, 52000, 45500 });
		AddPointToLine({ 119000, 56000, 42500 });
		AddPointToLine({ 111000, 57000, 44000 });
		AddPointToLine({ 104000, 54500, 47500 });
		...
		NewLine();
		AddPointToLine({ 102000, 44500, 40500 });
		AddPointToLine({ 107000, 40000, 45500 });
		AddPointToLine({ 113000, 38000, 51500 });
		AddPointToLine({ 120000, 39500, 55500 });
		AddPointToLine({ 124000, 44000, 55000 });
		AddPointToLine({ 124000, 49000, 50500 });
		AddPointToLine({ 120000, 53500, 46000 });
		AddPointToLine({ 114000, 55500, 44500 });
		AddPointToLine({ 108000, 53500, 46000 });
		AddPointToLine({ 104000, 50000, 49500 });


		// ============================================================
		// ОБВИТИЕ №6 — ВЫШЕ ЗВЕЗДЫ
		// ============================================================
		...
		AddPointToLine({ 111000, 32000, 67500 });
		AddPointToLine({ 122000, 35000, 63000 });
		AddPointToLine({ 132000, 42000, 56500 });
		AddPointToLine({ 137000, 50000, 49000 });
		AddPointToLine({ 133000, 57000, 43000 });
		AddPointToLine({ 123000, 63000, 40000 });


		// ============================================================
		// ОБВИТИЕ №7 — НИЖНЯЯ СТОРОНА
		// ============================================================

		NewLine();
		AddPointToLine({ 90000, 62000, 45500 });
		AddPointToLine({ 92000, 68000, 51000 });
		AddPointToLine({ 97000, 72000, 58000 });
		AddPointToLine({ 105000, 73500, 63500 });
		AddPointToLine({ 114000, 72000, 66000 });
		AddPointToLine({ 123000, 68000, 63500 });
		AddPointToLine({ 130000, 62000, 57500 });
		AddPointToLine({ 133000, 55000, 50000 });
		AddPointToLine({ 130000, 49000, 44500 });
		AddPointToLine({ 123000, 45000, 42000 });


		// ============================================================
		// ОБВИТИЕ №8 — ГЛУБОКАЯ НИТЬ
		// ============================================================

		NewLine();
		AddPointToLine({ 95000, 65000, 40000 });
		AddPointToLine({ 100000, 70000, 45000 });
		AddPointToLine({ 107000, 75000, 52000 });
		AddPointToLine({ 116000, 76500, 59000 });
		AddPointToLine({ 125000, 73500, 65000 });
		AddPointToLine({ 133000, 67500, 67000 });
		AddPointToLine({ 139000, 60500, 62500 });
		AddPointToLine({ 141000, 53000, 56000 });
		AddPointToLine({ 137000, 46500, 49000 });
		AddPointToLine({ 130000, 42000, 43500 });


		// ============================================================
		// ОБВИТИЕ №9 — ПЕРЕКРЁСТНАЯ НИТЬ
		// ============================================================

		NewLine();
		AddPointToLine({ 88000, 55000, 60000 });
		AddPointToLine({ 92000, 47000, 66000 });
		AddPointToLine({ 99000, 40500, 69000 });
		AddPointToLine({ 108000, 37500, 65000 });
		AddPointToLine({ 118000, 39000, 59000 });
		AddPointToLine({ 128000, 44000, 52500 });
		AddPointToLine({ 134000, 51000, 45500 });
		AddPointToLine({ 131000, 58000, 41000 });
		AddPointToLine({ 123000, 63500, 43000 });
		AddPointToLine({ 113000, 65500, 48500 });


		// ============================================================
		// ОБВИТИЕ №10 — ПЕРЕКРЁСТНАЯ НИТЬ С ДРУГОЙ ГЛУБИНОЙ
		// ============================================================

		NewLine();
		AddPointToLine({ 91000, 49000, 41000 });
		AddPointToLine({ 94000, 41500, 45000 });
		AddPointToLine({ 100000, 36000, 51500 });
		AddPointToLine({ 109000, 33500, 58000 });
		AddPointToLine({ 119000, 35000, 62500 });
		AddPointToLine({ 128000, 40500, 61500 });
		AddPointToLine({ 136000, 47000, 56000 });
		AddPointToLine({ 139000, 54000, 49000 });
		AddPointToLine({ 135000, 60500, 43000 });
		AddPointToLine({ 126000, 65000, 40000 });


		// ============================================================
		// ОБВИТИЕ №11 — САМАЯ ВНУТРЕННЯЯ НИТЬ
		// ============================================================

		NewLine();
		AddPointToLine({ 100000, 47000, 42500 });
		AddPointToLine({ 103000, 42000, 47000 });
		AddPointToLine({ 108000, 39000, 52500 });
		AddPointToLine({ 115000, 39500, 56500 });
		AddPointToLine({ 121000, 43000, 57500 });
		AddPointToLine({ 124000, 47500, 53500 });
		AddPointToLine({ 122000, 52000, 48500 });
		AddPointToLine({ 117000, 55500, 45500 });
		AddPointToLine({ 111000, 56000, 46500 });
		AddPointToLine({ 106000, 53500, 49500 });
		...
		NewLine();
		AddPointToLine({ 103000, 60000, 45500 });
		AddPointToLine({ 100000, 56000, 50000 });
		AddPointToLine({ 101000, 51000, 55500 });
		AddPointToLine({ 105000, 45500, 59000 });
		AddPointToLine({ 112000, 42000, 60000 });
		AddPointToLine({ 119000, 43000, 56500 });
		AddPointToLine({ 123000, 47500, 51500 });
		AddPointToLine({ 122000, 52500, 46500 });
		AddPointToLine({ 117000, 56500, 43500 });
		AddPointToLine({ 110000, 58500, 45000 });
		...
		NewLine();
		AddPointToLine({ 96000, 37000, 57500 });
		AddPointToLine({ 101000, 31500, 62500 });
		AddPointToLine({ 109000, 28500, 65500 });
		AddPointToLine({ 118000, 30000, 63500 });
		AddPointToLine({ 127000, 34500, 59000 });
		AddPointToLine({ 133000, 41000, 52500 });
		AddPointToLine({ 136000, 48500, 45500 });
		AddPointToLine({ 132000, 56000, 40000 });
		AddPointToLine({ 124000, 61500, 38500 });
		AddPointToLine({ 114000, 64500, 41000 });
		...
		NewLine();
		AddPointToLine({ 92000, 60000, 43000 });
		AddPointToLine({ 95000, 67000, 47000 });
		AddPointToLine({ 101000, 72500, 53000 });
		AddPointToLine({ 109000, 75500, 60000 });
		AddPointToLine({ 118000, 74500, 65500 });
		AddPointToLine({ 127000, 70000, 67500 });
		AddPointToLine({ 134000, 63500, 62500 });
		AddPointToLine({ 138000, 56500, 55500 });
		AddPointToLine({ 137000, 49500, 48500 });
		AddPointToLine({ 132000, 44000, 43500 });
